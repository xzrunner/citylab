...
#define PARM_FILEPATH citygraph/operator/##PARM_NODE_CLASS##.parm.h
#endif

#define RTTR_NAME citylab::##PARM_NODE_NAME

rttr::registration::class_<citylab::node::PARM_NODE_CLASS>(XSTR(RTTR_NAME))
.constructor<>()

#define PARAM_INFO(id, type, name, member, default_val)        \
.property(#name, &citylab::node::##PARM_NODE_CLASS::member)        \
(                                                              \
